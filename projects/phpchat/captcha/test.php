...
<ul>
    <li><strong>Session Functionality:</strong>
        ...
        <?php if ($GLOBALS['session_start_error'] != null): ?>
            <br/><span style="color: #f00">There may be a problem with session support.</span>
            <br/><?php echo $GLOBALS['session_start_error'] ?>
            <br/>
        <?php endif; ?></li>
    ...
    <li><strong>imageftbbox function:</strong>
        ...
        <?php if (function_exists('imageftbbox') == false): ?>
            <br/>The <a href="http://php.net/imageftbbox"
                        target="_new">imageftbbox()</a> function is not included with your gd build. This function is required.
        <?php endif; ?></li>
